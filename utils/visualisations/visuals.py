        ...
        if target_points is None:
            ...
            if with_img == True:
                if w_landmarks == True:
                    ...
                    ax.scatter(target_points[:, 0]/self.pixelsize, target_points[:, 1]/self.pixelsize, color='lime', s=2)
                    ax.scatter(predicted_points[:, 0]/self.pixelsize, predicted_points[:, 1]/self.pixelsize, color='red', s=2)
                else:
                    ax.scatter(predicted_points[:, 0]/self.pixelsize, predicted_points[:, 1]/self.pixelsize, color='red', s=2)
                    ax.imshow(image, cmap='Greys_r',alpha=0.4)
